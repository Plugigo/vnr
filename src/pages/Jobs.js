...
const TYPES = [
  { key: 'job', label: 'Local Jobs' },
  { key: 'mgnrega', label: 'MGNREGA Updates' }
];
...
export default function Jobs() {
  ...
  useEffect(() => {
    setLoading(true);
    const q = query(collection(db, 'jobs'), orderBy('type'));
